...
- 项目: `D:\mimo\worktrees\MiMo Multimodal Iterative Testing\examples\mit-demo-webapi`
- RC: `RC-1`  rc_sha: `2db6c86fef5a4580ae62ecedca2845a41f0d1bfd0c7c2d88599cd4eaba61f0ac`
- 轮次: 1  matrix_rev: `m2`
- 生成时间: 2026-09-25T03:01:45Z
- 结论草稿: `in_progress`

## 2. 项目画像与矩阵覆盖

- app_types: ['web', 'api', 'db']
- runtime: node@20
- topology: api
...
| cli | n/a | excluded |  |
| db | optional | unavailable | no probe wired |
| infra | n/a | excluded |  |
| av | n/a | excluded |  |
| canvas | n/a | excluded |  |
| 3d | n/a | excluded |  |
...
- quiet_streak: 0
- signals: `{"build_ok": true, "matrix_required_coverage": 0.5, "required_gaps": ["web:blind_spot", "av:blind_spot", "3d:blind_spot"], "optional_degraded": ["db:unavailable"], "open_p0": 0, "open_p1": 0, "open_p2": 0, "p2_user_accepted": false, "regression_green": true, "fixed_without_regression": [], "device_coverage": 0.0, "device_all_sim": true, "data_mask_clean": true, "release_layers": {"artifact_ready": false, "exposure_ready": false, "exposure_constraint": "no_prod_or_coverage_gap_conditional_only"}, "prod_test": {"available": false, "mode": "none", "slis": [], "critical_path_pass": null}, "oracle_quality": {"k": 0, "agreement_rate": null, "fp_rate_estimate": null}, "contract_breaking_unreviewed": false, "blind_spots": ["RC-1:web", "RC-1:av", "RC-1:3d"], "quiet_streak": 0}`
