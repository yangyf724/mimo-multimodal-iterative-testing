...
```powershell
# 修复后重新采集
& $env:MIMO_PYTHON mmit-hunter/scripts/capture_web.py --root <project> --run-id run-fix --out <project>/.bug-hunter/runs/run-fix/captures

# 跑门
& $env:MIMO_PYTHON mmit-hunter/scripts/fix_gate.py --root <project> `
  --bug bug-0001 `
