#!/usr/bin/env python3
"""Project profile scan for mmit (MMIT-Test)."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--out", type=Path, default=None, help="output path (default .mmit/profile.json)")
...
def main(argv: list[str] | None = None) -> int:
    ...
    out = args.out or (ensure_tests(root) / "profile.json")
