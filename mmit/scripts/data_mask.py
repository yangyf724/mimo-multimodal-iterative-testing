#!/usr/bin/env python3
"""Data masking hard gate for MMIT-Test. Refuses to run when secrets/PII leak into fixtures."""
...
from mmit_lib import ensure_tests, ensure_mit, utc_now, write_json  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    out = args.out or (ensure_tests(root) / "data_mask_report.json")
