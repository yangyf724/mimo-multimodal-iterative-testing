...
路径根：目标项目 `.mmit/deliverables/`。缺件不得进入 Allow。

## 交付物清单

| 交付物 | 路径 | 必要性 |
|--------|------|--------|
| **测试报告** | `.mmit/deliverables/TEST_REPORT.md` | 必须 |
| **证据包** | `.mmit/deliverables/evidence/` + `EVIDENCE_INDEX.md` | 必须 |
| **裁决信号** | `.mmit/deliverables/adjudication_signals.json` | 必须 |
| **发布裁决** | `.mmit/deliverables/RELEASE_DECISION.md` | 必须 |
| 机读导出 | `.mmit/deliverables/export.json` | 建议 |
| 升级包 | `.mmit/escalation/` | 触发升级时必须 |
