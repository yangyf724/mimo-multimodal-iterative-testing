...
```bash
python scripts/fp_feedback.py absorb --root . --bug .mmit/bugs/rejected/bug-0007.json
...
python scripts/fp_feedback.py agents-snippet --root . --out AGENTS.mmit.snippet.md
