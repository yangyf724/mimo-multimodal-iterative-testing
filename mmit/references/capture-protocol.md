...
# 或显式指定
& $env:MIMO_PYTHON mmit/scripts/capture_web.py --root <project> `
  --base-url http://127.0.0.1:5173 --routes / /about --viewports 375x812 1440x900

# Phase 2：分片 + 汇总
& $env:MIMO_PYTHON mmit/scripts/capture_web.py --root <project> --run-id run-1 --shard 0/2
& $env:MIMO_PYTHON mmit/scripts/capture_web.py merge --root <project> --run-id run-1
```
