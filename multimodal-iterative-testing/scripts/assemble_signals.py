#!/usr/bin/env python3
"""Assemble adjudication_signals.json for MIT-Test."""
...
from mit_lib import ensure_mit, load_state, read_json, save_state, utc_now, write_json  # noqa: E402
...
def build_signals(root: Path) -> dict[str, Any]:
    ...
    defects_dir = ensure_mit(root) / "defects"
